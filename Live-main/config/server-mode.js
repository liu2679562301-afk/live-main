...
// export const API_BASE_URL = 'http://localhost:8081'; // 连接Spring Boot后端服务
// export const API_BASE_URL = 'https://live-debate-backend-production.up.railway.app'; // Railway生产环境后端
export const API_BASE_URL = 'https://live-debate-gateway-production.up.railway.app'; // 使用网关（推荐）
