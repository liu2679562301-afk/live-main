...
// === 只改这一行即可一键切换全局API ===
export const API_BASE_URL = LOCAL_SERVER_URL; // 本地调试就用 LOCAL_SERVER_URL (http://localhost:8081)
// export const API_BASE_URL = 'http://localhost:8080'; // 通过网关服务器 (http://localhost:8080)
